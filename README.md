...
*   **Image Processing Engines:** `libvips`, [ImageMagick](https://imagemagick.org/), `R` (e.g. [EBImage](https://bioconductor.org/packages/release/bioc/html/EBImage.html)), `Python 3` (e.g. `ultralytics`)
